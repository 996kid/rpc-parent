...
public class MessageCodecSharable extends MessageToMessageCodec<ByteBuf, RpcRequestMessage> {

    protected void encode(ChannelHandlerContext ctx, RpcRequestMessage in, List<Object> outList) throws Exception {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        RpcResponseMessage rpcRequestMessage = serializerAlgorithm.deserialize(RpcResponseMessage.class, bytes);
